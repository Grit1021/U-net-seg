...
if __name__ == '__main__':
    ...
    def demo():
        ...
        train_path = r'/Users/software/codes ZMIC/U-net seg/MSCMR2019/T2/npy'

        center_crop = joint_trans.CenterCrop(160)
        tes_center_crop = joint_trans.SingleCenterCrop(160)
        ...
        for input, mask, _ in train_loader:
            ...
            b = helper.onehot_to_mask(np.array(mask.squeeze()).transpose([1, 2, 0]), custom_palette)
