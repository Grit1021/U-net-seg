...
if __name__ == '__main__':
    types = ['C0', 'DE', 'T2']
    dataset_kfold(os.path.join('/Users/software/codes ZMIC/U-net seg/MSCMR2019', types[2], 'npy/Labels'),
                  os.path.join('/Users/software/codes ZMIC/U-net seg/MSCMR2019', types[2], 'npy'))